...
def get_node_fea(data_set, train_num=0.6):
    ...
    elif data_set == 'dc1-taxi':
        path = 'data/h5data/dc1-taxi.h5'
    elif data_set == 'chi-taxi':
        path = 'data/h5data/chi-taxi.h5'
    elif data_set == 'pems03':
        path = 'data/h5data/pems03.h5'
    elif data_set == 'dc5-taxi':
        path = 'data/h5data/dc5-taxi.h5'
    elif data_set == 'dc6-taxi':
        path = 'data/h5data/dc6-taxi.h5'
    elif data_set == 'dc7-taxi':
        path = 'data/h5data/dc7-taxi.h5'
    else:
        raise ('No such dataset........................................')



    if data_set == 'nyc-bike' or data_set== 'nyc-taxi' or data_set== 'pems03':
        x = h5py.File(path, 'r')
        data = list()
        for key in x.keys():
            data.append(x[key][:])
...
def load_dataset(dataset, batch_size, valid_batch_size= None, test_batch_size=None):
    ...
    for category in ['train', 'val', 'test']:
        ...
        # print(cat_data.files) x,y,x_offsets,y_offsets
        # print(cat_data['x'][0][0][0])
        # print(cat_data['y'][0][0][0])
        data['raw_x_'+category] = cat_data['x']
        data['x_' + category] = cat_data['x']
        data['y_' + category] = cat_data['y']
    if dataset == 'nyc-bike' or dataset =='nyc-taxi' or dataset =='pems03' \
        or dataset == 'bos-bike' or dataset == 'bay-bike' or dataset == 'dc-bike' or dataset == 'dc-taxi' or dataset == 'chi-taxi' or dataset== 'dc1-taxi' or dataset == 'dc5-taxi' or dataset == 'dc6-taxi' or dataset == 'dc7-taxi':
